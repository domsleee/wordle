...
./bin/solve -r --hard-mode --max-tries 3 --max-incorrect 150 -w slate --force-sequential ext/wordle-guesses.txt ext/wordle-answers.txt
...
./bin/solve -p -I17 -N2000 --max-tries 4 --guesses-to-skip ./databases/skip ext/wordle-guesses.txt ext/wordle-answers.txt
