...
./bin/solve -r --hard-mode --max-tries 3 -I150 -w slate --force-sequential ext/wordle-guesses.txt ext/wordle-answers.txt
...
./bin/solve -I20 -g4 -p ext/wordle-guesses.txt ext/wordle-answers.txt
